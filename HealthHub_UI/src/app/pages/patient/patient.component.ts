...
totalEmployees: string;
 ...
 total = 0;
  ...
  constructor(_router: Router, private _http: Http) {
   ...
   private loadIntialListOfpatients() {
     this.isLoading = true;
     return this._http.get('http://localhost:8181/healthhubapi/listAllPatients')
 ...
 public edit(id: string) {
  ...
  public delete(id:string) {
    ...
    this.isLoading = true;
    return this._http.delete('http://localhost:8181/healthhubapi/deletePatient/' + this.deleteId)    
     .subscribe(data => {            
